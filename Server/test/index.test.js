...
describe("Test de RUTAS", () => {
    describe('GET /rickandmorty/character/:id', () => {
        ...
        const responde = (await agent.get('/rickandmorty/character/1')).body;
    ...
    describe('GET /rickandmorty/login', () => {
        it('Ruta de login retorna access true', async () => {
            const response = (await agent.get('/rickandmorty/login?email=${email}&password=${password}')).body;
    ...
    describe ('POST /rickandmorty/fav', () => {
        ...
        it('Devuelve elemento enviado previamente con los 2 personajes', async () => {
    ...
    describe ('DELETE /rickandmorty/fav:id', () => {
        ...
        it('Devuelve los personajes con un iD invalido', async () => {
